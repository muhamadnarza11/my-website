...
if(isset($_GET['delete']))
{
    ...
    Data berhasil dihapus
        ...
        <?php
    header('refresh:3;URL=http://localhost/19_mywebsite_12RPL1/admin.php?page=anggota');
...
if(isset($_POST['save'])){
    ...
    VALUES('$id','$nis','$nama','$kelas','$jurusan','$tgllhr','$tlpn','$almt','$jk')");
    if($query_insert)
    {
        ?>
        ...
        <div class="modal-body">
            ...
            <div class="form-group mt-2 ">
                <label for="nis">ID</label><br>
                    <input class="form-control" type="text" name="id" placeholder="Masukan ID anda" required>
                </div>
                <div class="form-group mt-2 ">
                ...
                <label for="no_tlp">Telpon</label><br>
                    <input class="form-control" type="text" name="tlpn" placeholder="No Telpon">
                </div>
                <div class="form-group mt-2">
